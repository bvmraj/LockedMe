...
public class LockedMe {
    ...
    private static final String SELECT_ANY_THE_FOLLOWING =
            "\n Select any of the following: \n"+
                    "1 -> List files in directory\n"+
                    "2 -> Add, Delete or Search\n"+
                    "3 -> Exit Program";

    private static final String SELECT_FILE_OPERATIONS =
    ...
    void showPrimaryMenu() {
        System.out.println(SELECT_ANY_THE_FOLLOWING);
        try{
    ...
    void showSecondaryMenu() {
        System.out.println(SELECT_FILE_OPERATIONS);
        try{
